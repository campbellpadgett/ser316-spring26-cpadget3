...
| Test ID Name                          | EP/BVA          | Input Description                                                                                                          | Expected Return | Expected State Changes                                                                     | Checkout0 | Checkout1 | Checkout2 | Checkout3 |
|---------------------------------------|-----------------|----------------------------------------------------------------------------------------------------------------------------|-----------------|--------------------------------------------------------------------------------------------|-----------|-----------|-----------|-----------|
| T1 testPatronIsNull                   | EP 5.6          | patron = null, book non-null, refOnly=false, availableCopies=5                                                             | 3.1             | No state change                                                                            |           |           |           |           |
| T2 testSuspendedPatron                | EP 5.1          | patron STUDENT, suspended=true, fines=0, overdue=0, book not null, refOnly=false, availableCopies=5, not renewal           | 3.0             | No state change, availableCopies unchanged, patron map/count unchanged                     |           |           |           |           |
| T3 testSuspendedWithBookNull          | EP 5.2          | patron PUBLIC, suspended=true, book = null                                                                                 | 3.0             | No state change                                                                            |           |           |           |           |
| T4 testFinesAtThreshold               | BVA 3.3         | patron STAFF, suspended=false, fines=10.00, overdue=0, book non-null, availableCopies=5, refOnly=false                     | 4.1             | No state change, copies unchanged, patron map/count unchanged                              |           |           |           |           |
| T5 testFinesBelow                     | BVA 3.2         | patron STAFF, fines=9.99, overdue=0, checkoutCount=0, book availableCopies=5, refOnly=false, not renewal                   | 0.0             | Success, availableCopies -1, patron count +1, patron map adds ISBN-1 with dueDate=today+45 |           |           |           |           |
| T6 testOverdueAtBoundary              | BVA 1.3         | patron STUDENT, overdue=3, fines=0, suspended=false, book availableCopies=5, refOnly=false                                 | 4.0             | No state change                                                                            |           |           |           |           |
| T7 testOverdueWarning                 | BVA 1.2         | patron STUDENT, overdue=2, fines=0, suspended=false, checkoutCount=0, book availableCopies=5, refOnly=false                | 1.0             | Success with warning, copies -1, count +1, map adds ISBN-1 with dueDate=today+30           |           |           |           |           |
| T8 testBookIsNullButEligiblePatron    | EP 3.1          | patron FACULTY, eligible, suspended=false, overdue=0, fines=0, book=null                                                   | 2.1             | No state change                                                                            |           |           |           |           |
| T9 testBookIsReferenceOnly            | EP 2.1          | patron PUBLIC, eligible, book non-null, refOnly=true, availableCopies=10                                                   | 5.0             | No state change, copies unchanged, patron map unchanged                                    |           |           |           |           |
| T10 testBookIsReferenceOnly           | EP 1.1          | patron STUDENT, eligible, book non-null, refOnly=false, availableCopies=0, not renewal, checkoutCount=0                    | 2.0             | No state change                                                                            |           |           |           |           |
| T11 testCheckout                      | EP 1.2          | patron PUBLIC, eligible, overdue=0, fines=0, checkoutCount=0, book availableCopies=2, refOnly=false, not renewal           | 0.0             | Success, copies 2 to 1, count 0 to 1, map adds ISBN-1 dueDate=today+21                     |           |           |           |           |
| T12 testRenewal                       | EP 6.1, EP 4.8  | patron STUDENT, eligible, patron map already contains ISBN-1 with old dueDate, book availableCopies=0, refOnly=false       | 0.1             | Renewal, patron map dueDate for ISBN-1 overwritten to today+30, count unchanged            |           |           |           |           |
| T13 testRenewalBlockedByReferenceOnly | EP 6.5          | patron STUDENT, eligible, patron already has ISBN-1 checked out, book refOnly=true, availableCopies=5                      | 5.0             | No state change (no dueDate update, copies unchanged)                                      |           |           |           |           |
| T14 testRenewalBlockedByFines         | EP 6.8, BVA 3.3 | patron STUDENT, fines=10.00, patron already has ISBN-1, book refOnly=false, availableCopies=5                              | 4.1             | No state change (no dueDate update, copies unchanged)                                      |           |           |           |           |
| T15 testCheckoutAtMaxLimit            | EP 4.6, BVA 1.5 | patron STUDENT, eligible, checkoutCount=10, at max, overdue=0, fines=0, book availableCopies=5, refOnly=false, not renewal | 3.2             | No state change, copies unchanged, patron map/count unchanged                              |           |           |           |           |
| T16 testCheckoutAboveMaxLimit         | BVA 1.6         | patron PUBLIC, eligible, checkoutCount=6, max 5 +1, overdue=0, fines=0, book availableCopies=5, refOnly=false, not renewal | 3.2             | No state change                                                                            |           |           |           |           |
| T17 testCheckoutBelowMax              | BVA 1.4         | patron STUDENT, eligible, checkoutCount=9, max-1, overdue=0, book availableCopies=5, refOnly=false, not renewal            | 1.1             | Success, copies -1, count 9 to 10, map adds ISBN-1 dueDate=today+30                        |           |           |           |           |
| T18 testCheckoutAtWarning             | BVA 1.2         | patron STUDENT, eligible, checkoutCount=7, max-3, overdue=0, book availableCopies=5, refOnly=false, not renewal            | 1.1             | Success, copies -1, count 7 to 8, map adds ISBN-1 dueDate=today+30                         |           |           |           |           |
| T19 testCheckoutBelowWarning          | BVA 1.1         | patron STUDENT, eligible, checkoutCount=6, max-4, overdue=0, book availableCopies=5, refOnly=false, not renewal            | 0.0             | Success, copies -1, count 6 to 7, map adds ISBN-1 dueDate=today+30                         |           |           |           |           |
| T20 testChildWarning                  | EP 4.7          | patron CHILD, eligible, checkoutCount=0, overdue=0, book availableCopies=5, refOnly=false, not renewal                     | 1.1             | Success, copies -1, count 0 to 1, map adds ISBN-1 dueDate=today+14                         |           |           |           |           |
